...
public class TemperatureEncoder {

    public String prepareTemperatureMessage(SensorData data) {
        ...
        return pattern
                ...
                .replace("${can-id}", "0xAA")
                .replace("${payload}", transformTemperatureToPayloadForm(data.temperature()));
    }
